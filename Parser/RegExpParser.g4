...
regexp_statement
	: ID? COLON regexp  action_code? SEMICOLON
;


action_code
	: STARTCODEANCHOR CODE ENDCODEANCHOR
; 


regexp
	: regexp ALTERNATION regexp_conc	#regexp_alternation
	| regexp_conc						#regexp_alternation_other
;


regexp_conc
	:  regexp_conc regexp_closure		#regexp_concatenation
	|  regexp_closure					#regexp_concatenation_other
;


regexp_closure
	: regexp_closure quantifier			#regexp_clos
	| regexp_basic						#regexp_clos_other
;


regexp_basic
	: LP regexp RP						#regexpbasic_parenthesized
	| set								#regexpbasic_set
...
assertions
	: LP QMARK EQUAL regexp  RP			#assertion_fwdpos	// forward positive predicate
...
finate_closure_range
	: LCA NUMBER (COMMAC NUMBER? )?  RAC
;


set
	: LB setitems RB					#setofitems
